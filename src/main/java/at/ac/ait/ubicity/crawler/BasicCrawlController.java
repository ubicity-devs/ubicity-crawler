...
import at.ac.ait.ubicity.crawler.frontier.UbicityDocIDServer;
...
public class BasicCrawlController extends CrawlController {

    
    static final Logger logger = Logger.getLogger( BasicCrawlController.class.getName());
    
    
    private BasicCrawlController( CrawlConfig config, PageFetcher pageFetcher, RobotstxtServer robotstxtServer ) throws Exception {
